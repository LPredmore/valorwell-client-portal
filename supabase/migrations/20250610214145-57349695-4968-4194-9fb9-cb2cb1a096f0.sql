...
-- Create a comprehensive, properly error-handled trigger function
...
VALUES (
  '20250610_comprehensive_user_trigger_fix',
  'Completely rewrote handle_new_user function with comprehensive logging and error handling',
  jsonb_build_object(
